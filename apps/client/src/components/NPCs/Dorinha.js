 ...
 *
 * This module exports the NPC identifier, schedule/location data, and sprite
 * paths. It is plain JS (no React or TypeScript) so it can also be used
 * server-side or in test environments without a bundler.
 *
...
/**
 * Idle sprite path served from public/.
 * File: public/assets/npcs/dorinha.png
 */
export const DORINHA_SPRITE = 'assets/npcs/dorinha.png';
