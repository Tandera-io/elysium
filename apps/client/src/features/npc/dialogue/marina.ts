...
export const MARINA_TOPICS: Record<string, MarinaQuickReply[]> = {
  receitas: [
    ...
    { label: 'Ingredientes especiais', input: 'Você usa algum ingrediente especial nos seus pães?' },
    { label: 'Pão mais difícil', input: 'Qual é o pão mais difícil de fazer?' },
  ],
  ingredientes: [
    { label: 'Precisa de trigo?', input: 'Você está precisando de trigo? Posso trazer da minha roça.' },
  ...
  conversa: [
    ...
    { label: 'Perguntar sobre Bento', input: 'Você e o Bento se dão bem? Ele parece tão carrancudo...' },
  ],
};
