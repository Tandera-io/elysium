...
export const PADRE_PEDRO_GREETINGS: PadrePedroQuickReply[] = [
  ...
  {
    label: 'Falar sobre a comunidade',
    input: 'Como estão as famílias da vila, Padre Pedro?',
  },
...
export const PADRE_PEDRO_TOPICS: Record<string, PadrePedroQuickReply[]> = {
  general: [
    {
      label: 'Falar sobre a fé',
      input: 'O que a fé tem a ver com a vida na roça, Padre?',
    },
    {
    ...
    {
      label: 'Tradições da vila',
      input: 'Quais são as festas religiosas mais importantes aqui?',
    },
  ],
  spiritual: [
    {
    ...
    {
      label: 'Sobre a missa',
      input: 'Em que horário é a próxima missa, Padre Pedro?',
    },
  ],
  community: [
