...
/** @type {Map<string, import('../npc/NPCs/Ferraz.js').FerrazQuickReply[]>} */
const _greetings = new Map();

/** @type {Map<string, Record<string, import('../npc/NPCs/Ferraz.js').FerrazQuickReply[]>>} */
...
registerNPC(NINA_DIALOGUE);
registerNPC(DORINHA_DIALOGUE);
