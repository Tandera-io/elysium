      ...
      <div className="bg-slate-900 border border-amber-600/40 rounded-2xl p-5 w-[420px] max-w-[95vw] shadow-2xl">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-amber-400 font-semibold">🪙 {gold}</span>
            <button
              onClick={closeShop}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={() => adjustQty(buyQty, setBuyQty, seed.id, -1, seed.stock)}
                      className="w-6 h-6 rounded bg-slate-700 text-slate-300 hover:bg-slate-600 text-sm flex items-center justify-center"
                    >
                      –
                    </button>
            ...
            {crops.map((crop) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={() => adjustQty(sellQty, setSellQty, crop.id, -1, have)}
                      disabled={have === 0}
                      className="w-6 h-6 rounded bg-slate-700 text-slate-300 hover:bg-slate-600 text-sm flex items-center justify-center disabled:opacity-40"
                    >
                      –
                    </button>
                    <span className="w-6 text-center text-sm text-slate-100">{qty}</span>
