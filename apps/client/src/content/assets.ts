...
export const SPRITES = {
  ...
  dorinha: 'sprites/cache/50abe456f7d3f935.png',
} as const;
...
export const WALK_CYCLES: Partial<Record<keyof typeof SPRITES, string[]>> = {
  ...
  dorinha: [
    'sprites/cache/50abe456f7d3f935.png', // idle (frame 0)
    'sprites/cache/7ca40c4410ad1460.png', // walk 1 (left step)
    'sprites/cache/50abe456f7d3f935.png', // idle (frame 2 = sandwich)
    'sprites/cache/c2daeecd8b188ac4.png', // walk 2 (right step)
  ],
};
