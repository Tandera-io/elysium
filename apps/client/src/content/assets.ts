...
export const WALK_CYCLES: Partial<Record<keyof typeof SPRITES, string[]>> = {
  ...
  // Source spritesheet: assets/sprites/dorinha-walk-cycle.png (4-frame horizontal strip).
  dorinha: [
    'sprites/cache/86c32aed8fdfe173.png', // frame 0: idle
    'sprites/cache/c53b7e283fcc0989.png', // frame 1: left leg forward
    'sprites/cache/86c32aed8fdfe173.png', // frame 2: idle (sandwich)
    'sprites/cache/0e9b80073ba31315.png', // frame 3: right leg forward
  ],
};
