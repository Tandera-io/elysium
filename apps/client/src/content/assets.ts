...
export const SPRITES = {
  ...
  padre_pedro: 'sprites/cache/padre-pedro.png',
} as const;
...
/**
 * Per-growth-stage sprites for each crop. Index matches CropStage.index.
 * The final entry is the pre-harvest stage; mature tiles use CROP_SPRITES.
 */
export const CROP_STAGE_SPRITES: Record<keyof typeof CROP_SPRITES, string[]> = {
  wheat: [
