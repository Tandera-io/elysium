...
// provides hand-authored starter quest definitions, and adds imperative
// helpers that Phaser scenes and non-React code can call.
//
// Exported surface:
...
//
// These quests are always available from day 1 and do not depend on the
// economy simulation.  They use EconomyItemId values so they map cleanly
// onto QuestPanel and DialogueBox quest widgets.
//
...
export const STARTER_QUESTS = [
  ...
  // Dorinha (quitandeira) needs tomatoes to restock the stall.
  {
  ...
  // Marina (padeira) needs extra wheat to bake pão francês.
  {
