/**
 * Economy-flow transaction tracker for NPC interactions.
 * Records gold movements and item exchanges that occur during dialogue.
 */
...
/**
 * @typedef {'buy' | 'sell' | 'quest_reward' | 'gift'} TransactionType
 *
